<script>
    ...
    let delete_post = async () => {
        let res = await fetch('http://localhost:8080/posts/delete',{
            method: "DELETE",
            headers: {'Content-Type': 'application/json'}, 
    ...
    let add_comment = async (post_id) => {
        ...
        let res = await fetch('http://localhost:8080/comments/create', 
        {
            method: 'POST',
            headers: {'Content-Type': 'application/json'}, 
    ...
    let delete_comment = async (comment) => {
        let res = await fetch('http://localhost:8080/comments/delete', 
        {
            method: 'DELETE',
            headers: {'Content-Type': 'application/json'}, 
