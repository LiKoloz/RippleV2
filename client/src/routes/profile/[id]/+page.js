...
async function getData(id) {
    ...
    console.log(`http://80.242.57.142:8080/users/get/${id}`)
    const res = await fetch(`http://80.242.57.142:8080/users/get/${id}`);
...
async function rating_history(id){
  const res = await fetch(`http://80.242.57.142:8080/users/rating/history/${id}`);
